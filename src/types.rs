...
pub struct SymExprInfoMetadata {
    ...
    pub user_bottom_stack: Option<String>,
    pub user_top_stack: Option<String>,
    pub floc: Option<String>,
}
...
// #[derive(Default)]
// pub struct SymExprTrieNode {
//     expr: String,
//     children: FxHashMap<String, SymExprTrieNode>,
//     user_bottom_stack: String,
//     user_top_stack: String,
//     floc: String,
// }

// impl SymExprTrieNode {
//     pub fn insert(&mut self, sym_expr_metadata: SymExprMetadata) {
//         let mutt cur = self;
